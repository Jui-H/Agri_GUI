...
async function startAutonomousFertilization() {
  ...
  /*
    Command path:
    GUI -> USB Serial -> base-station ESP32 -> LoRa -> rover

    Rover firmware should handle:
      ROVER,FERT,<milliseconds>
  */
  const command = `ROVER,FERT,${onTimeMs}`;
